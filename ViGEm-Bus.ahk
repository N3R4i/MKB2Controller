;Modified by N3R4i to have unified button syntax between PS4/XBox
#include CLR.ahk
...
class ViGEmDS4 extends ViGEmTarget {
	...
	__New(){
		static buttons := {X: 16, A: 32, B: 64, Y: 128, LB: 256, RB: 512, L2: 1024, R2: 2048
			, Back: 4096, Start: 8192, LS: 16384, RS: 32768 }
		static specialButtons := {Xbox: 1, TouchPad: 2}
		static axes := {LX: 2, RX: 4, LT: 0, RT: 1}
		static axesInverted := {LY: 3, RY: 5}
		...
		for name, id in axesInverted {
			this.Axes[name] := new this._AxisHelperInverted(this, id)
		}		
